...
class TelaBuscaConsulta extends StatefulWidget {
  ...
  @override
  State<TelaBuscaConsulta> createState() => _TelaBuscaConsultaState();
}

class _TelaBuscaConsultaState extends State<TelaBuscaConsulta> {
  ...
  Future<void> _buscar() async {
    ...
    final resultado = await ConsultaService.buscarMoradores(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Buscar em ${widget.nomeTerritorio}'),
        actions: [
          IconButton(
